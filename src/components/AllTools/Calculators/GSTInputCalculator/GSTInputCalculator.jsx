...
import "./GSTInputCalculator.css";

function GSTInputCalculator() {
          ...
          <div className="input_level2">
            <table className="input_table2">
              ...
              <tr>
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{tIgst}</div>
                  </div>
                </td>

                <td>
                  <div className="input_holder">
                    <div className="input_box2">{tCgst}</div>
                  </div>
                </td>
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{tSgst}</div>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{iIgst}</div>
                  </div>
                </td>

                <td>
                  <div className="input_holder">
                    <div className="input_box2">{iCgst}</div>
                  </div>
                </td>
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{iSgst}</div>
                  </div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{`(${credIgstC})`}</div>
                  </div>
                </td>
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">0</div>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{`(${credIgstS})`}</div>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{credCgstC}</div>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{credSgstC}</div>
                  </div>
                </td>
              ...
              <tr className="net_tax">
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{netTaxIgst}</div>
                  </div>
                </td>

                <td>
                  <div className="input_holder">
                    <div className="input_box2">{netTaxCgst}</div>
                  </div>
                </td>
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{netTaxSgst}</div>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{carryGST}</div>
                  </div>
                </td>

                <td>
                  <div className="input_holder">
                    <div className="input_box2">{carryCGST}</div>
                  </div>
                </td>
                <td>
                  <div className="input_holder">
                    <div className="input_box2">{carrySGST}</div>
                  </div>
                </td>
              </tr>
            </table>
...
export default GSTInputCalculator;
